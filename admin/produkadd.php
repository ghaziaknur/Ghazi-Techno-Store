...
<?php
if($_POST["simpan"]){
  if(!empty($_POST["idkat"]) and !empty($_POST["nama"]) and !empty($_POST["harga"]) and !empty($_POST["stok"]) and !empty($_POST["spesifikasi"]) and !empty($_POST["detail"]) and !empty($_POST["diskon"]) and !empty($_POST["berat"]) and !empty($_POST["isikotak"])){
