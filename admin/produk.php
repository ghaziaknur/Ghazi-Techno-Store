...
<a href="<?php echo "?p=produkadd"; ?>"><button type="button" class='btn btn-add'>Tambah Produk</button></a>
<br>
<?php  
$batas =  8;
$halaman = $_GET['pg'];
...
$sqlp = mysqli_query($kon, "select * from produk order by tglproduk desc limit $posisi, $batas");
  while($rp = mysqli_fetch_array($sqlp)){
	...
	echo "<br><a href='?p=produkdetail&id=$rp[idproduk]'><button type='button' class='btn btn-add'>Detail</button></a>
